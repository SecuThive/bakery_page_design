    ...
    <div className="bg-white text-gray-900 font-serif selection:bg-yellow-100 overflow-x-hidden pt-24 pb-20">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="mb-20">
          ...
          <Reveal>
            <h1 className="text-6xl lg:text-7xl font-bold text-gray-900 mb-4">베이킹 타임라인</h1>
            <p className="text-xl text-gray-600 max-w-2xl">매일 새벽부터 시작되는 명장의 빵 만드는 시간들</p>
          </Reveal>
        </div>
        ...
        <div className="mb-32">
          <Reveal delay={100} className="mb-20">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">매일의 리듬</h2>
            <p className="text-gray-600 font-light text-lg">정해진 시간에 따뜨하고 신선한 명장의 빵이 탄생합니다</p>
          </Reveal>
            ...
            {scheduleData.map((item, idx) => (
              <Reveal key={idx} delay={idx * 100}>
                <div className="group relative">
                  ...
                  <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg hover:shadow-xl transition-all border-2 border-gray-200 group-hover:border-yellow-600">
        ...
        <section className="mb-32">
          <Reveal delay={300} className="mb-20">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">운영 정보</h2>
            <div className="w-16 h-1 bg-yellow-600"></div>
          </Reveal>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Reveal delay={350}>
              <div className="bg-gradient-to-br from-yellow-50 to-white p-10 rounded-3xl border-2 border-yellow-200 hover:shadow-xl transition-all">
        ...
        {/* 특별 공지 */}
        <Reveal delay={450} className="bg-gradient-to-r from-yellow-100 via-yellow-50 to-white p-12 md:p-16 rounded-3xl border-l-4 border-yellow-700 mb-20">
